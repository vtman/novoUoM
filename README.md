...
If <tt>N</tt> is the number of samples, then we have <tt>2 N + 1</tt> bins for output files. The central bin corresponds to zero. The number of bins is the same for "short" and "long" versions. However, the bin sizes differ.
